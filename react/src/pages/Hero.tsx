	...
	return (
		<>
			<section className="mb-40">
				<nav
					className="relative flex w-full flex-wrap items-center justify-between bg-[#FBFBFB] py-2 text-neutral-500 shadow-lg hover:text-neutral-700 focus:text-neutral-700 dark:bg-gray-900 lg:py-4"
					data-te-navbar-ref
				>
					<div className="flex flex-wrap items-center justify-between w-full px-3">
						...
						>
							...
							>
								...
								>
									<Link
										...
										className="inline-block rounded px-6 pb-2 pt-2.5 text-lg font-medium uppercase leading-normal text-primary transition duration-150 ease-in-out hover:bg-neutral-600 hover:text-primary-500 focus:text-primary-600 focus:outline-none focus:ring-0 active:text-primary-700"
									>
										Dashboard
									</Link>
								</li>
							...
							<div className="flex items-center space-x-6">
								...
								<Link
									to="https://github.com/Francismiko/Tamer"
									type="button"
									data-te-ripple-init
									data-te-ripple-color="light"
